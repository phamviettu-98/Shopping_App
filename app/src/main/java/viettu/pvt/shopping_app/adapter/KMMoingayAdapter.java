...
public class KMMoingayAdapter extends RecyclerView.Adapter<KMMoingayAdapter.ViewHodler> {
    private Context context;
    private List<SanPham> list;
    SanPhamItemClick sanPhamItemClick;

    public KMMoingayAdapter(Context context, List<SanPham> list, SanPhamItemClick sanPhamItemClick) {
    ...
    class ViewHodler extends RecyclerView.ViewHolder{
       ...
       private ImageView img_sp, img_tet,img_sa1, img_sa2,img_sa3,img_sa4, img_sa5;
        ...
        public void bindView(int position) {
            ...
            tv_giacu.setText(list.get(position).getGiasanpham()+" ₫");
